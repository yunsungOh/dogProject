...
<body>
	...
	<div class="content-wrapper">
		<div style="width: 1200px; margin: 0 auto;">
			<h2>
				<img alt="" src="${path}/images/Logo/E.JPG">
			</h2>
			<div class="selectWrapper">
			<select id="selectOption" class="selectOption">
				<option value="${path}/shop/product/list_Ep.do">높은 가격순</option>
				<option value="${path}/shop/product/list_Ep2.do">낮은 가격순</option>
				<option value="${path}/shop/product/list_Ec.do">회사별</option>
				<option value="${path}/shop/product/list_En.do">이름순</option>
			</select>
