...
<body>
	...
	<div class="content-wrapper">
		<div style="width: 1200px; margin: 0 auto;">
			...
			<ul style="text-align: right; font-size: 20px; font-weight: bold;">
				<li style="display: inline;"><a
					href="${path}/shop/product/list_Ap.do" style="color: black;">가격순</a></li>
						<li style="display: inline;"><a
					href="${path}/shop/product/list_Ac.do" style="color: black;">회사별 </a></li>
						<li style="display: inline;"><a
					href="${path}/shop/product/list_An.do" style="color: black;">이름순</a></li>
			</ul>
		</div>
		<div class="list-view">
