...
<body>
	...
	<div class="content-wrapper">
		<div style="width: 1200px; margin: 0 auto;">
			<h2>
				<img alt="" src="${path}/images/Logo/B.JPG">
			</h2>
			
			<div class="selectWrapper">
			<select id="selectOption">
				<option value="${path}/shop/product/list_Bp.do">높은 가격순</option>
				<option value="${path}/shop/product/list_Bp2.do">낮은 가격순</option>
				<option value="${path}/shop/product/list_Bc.do">회사별</option>
				<option value="${path}/shop/product/list_Bn.do">이름순</option>
			</select>
