...
<body>
	...
	<div class="content-wrapper">
		<div style="width: 1200px; margin: 0 auto;">
			<h2>
				<img alt="" src="${path}/images/Logo/D.JPG">
			</h2>
			<div class="selectWrapper">
			<select id="selectOption">
				<option value="${path}/shop/product/list_Dp.do">높은 가격순</option>
				<option value="${path}/shop/product/list_Dp2.do">낮은 가격순</option>
				<option value="${path}/shop/product/list_Dc.do">회사별</option>
				<option value="${path}/shop/product/list_Dn.do">이름순</option>
			</select>
